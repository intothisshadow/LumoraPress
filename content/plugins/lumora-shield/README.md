...
The public author archive already refuses to reveal whether a username exists — an author with nothing published shows the same page as a made-up username, unconditionally, whether or not this plugin is active. **Lumora Shield &rsaquo; Settings** adds one further, optional step on top of that:
...
Every blocked author-archive request is logged at **Lumora Shield &rsaquo; Logs**: IP address, requested username, reason, and timestamp. Configurable at **Lumora Shield &rsaquo; Settings**:
