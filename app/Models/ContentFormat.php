 ...
 * the single place that branches on this value. `Plain` is the default
 * (existing rows keep rendering exactly as before: nl2br() over escaped
 * text) so migrating in this column never changes how any
